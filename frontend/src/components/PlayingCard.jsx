...
export const PlayingCard = ({ card, index = 0, size = "lg", selected = false }) => {
  ...
  const dims =
    size === "lg"
      ? "w-[92px] h-[132px] sm:w-[104px] sm:h-[148px] text-[15px]"
      : "w-16 h-24 text-xs";
